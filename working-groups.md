...
The PSF *[insert WG name]* is jointly governed by a Working Group (WG)
...
The WG meets weekly on Zoom. A designated moderator
...
*Note*: The DCO is mandatory for all PSF projects.
...
The [PSF Moderation Policy] applies to this WG.
